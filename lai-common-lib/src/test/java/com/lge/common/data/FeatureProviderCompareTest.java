...
public class FeatureProviderCompareTest {
    ...
    @Test public void compareObjectsWithoutFeatureList() {
    ...
    @Test public void compareObjectsWithoutFeatureList_FailureCase() {
        provider1.packageName = "com.example.helloworld";
        provider1.versionName = "1.0.0";
    ...
    @Test public void compareObjectsWithFeatureList() {
    ...
    @Test public void compareObjectsWithFeatureList_FailureCase() {
        Feature feature = new Feature();
        provider1.addFeature(feature);
