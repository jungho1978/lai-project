...
public class DAOUtilTest {
    ...
    @Test public void prepareStatment() throws SQLException {
        ...
        assertTrue(statment.toString().endsWith(
                "SELECT * FROM LGAppIF.asb WHERE _id = '1234' AND _pkg_name = 'com.example.helloworld'"));
    }

    @Test public void close_catchSQLException() throws Exception {
